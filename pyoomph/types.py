...
STRING.methods["has_continuation_byte_at"] = FunctionType([STRING, INT], BOOL)
...
STRING.methods["remove_prefix"] = FunctionType([STRING, STRING], OPTIONAL.get_type(STRING))
STRING.methods["remove_suffix"] = FunctionType([STRING, STRING], OPTIONAL.get_type(STRING))
